    ...
    <div className="relative">
      ...
      {isOpen && (
        ...
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg border border-gray-100 py-2 z-50">
          <p className="px-4 py-3 border-b border-gray-100">{companyName}</p>
          <p className="px-4 py-3 text-sm font-medium text-gray-900">{email}</p>
          <a
          ...
          <div className="border-t border-gray-100 mt-2 pt-2">
            <a href="#" onClick={onLogout} className="block px-4 py-3 text-sm  text-red-600 hover:bg-red-50 transition-colors ">
              Sign Out
            </a>
          </div>
        </div>
