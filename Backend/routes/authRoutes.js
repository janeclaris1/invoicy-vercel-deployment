...
const { registerUser, loginUser, getMe, updateUserProfile, getTeamMembers, createTeamMember, updateTeamMember, deleteTeamMember, forgotPassword, resetPassword } = require('../controller/authController');
